...
var Age, Height, Weight, Activity, BMRmale, BMRfemale, BMI, BFPadults, BFPchildren, Carbs40, Carbs65, Carbs75, Protein10, Protein35, Gender;
...
/*var ShowResult;
function render (){
    ShowResult = document.getElementById('Results')
